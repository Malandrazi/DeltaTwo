'  MVC System Response VBscript v1.0 by Thesawolf (thesawolf@gmail.com) 05/18/2014
' ================================================================================
' DESCRIPTION: 
'  Basic script to retrieve system information and provide Jarvis with a response
...
SysMode = "C" ' C - Check Mode, R - Report Mode
...
freewresp = "I'm starting to run out of room here!"
freeathreshold = 10 ' Specify free space ALERT/ALARM percentage threshold
freearesp = "Drive is out of free space sir"
'----------------------------------------------------------------------------------
...
procwresp = "Sir it Seems my average CPU load is high! I suggest closing some processes!"
procathreshold = 80 ' Specify cpu usage ALERT/ALARM threshold
procaresp = "Sir It Seems my average CPU load is very high! kill some processes please!"
'===----------------------------------------------------------------------------===
...
memwresp = "Sir,My memory isn't what it used to be, especially since something is hogging a bunch of it!"
memathreshold = 90 ' Specify ram usage ALERT/ALARM threshold
memaresp = "Sir my memory seems to be nearly gone because some process is using too much!"
...
netfresp = "I have detected network issues."
'===----------------------------------------------------------------------------===
AllClear = "Sir,All systems are operating efficiently!"
NotClear = "Well.. since you asked,There are parameters that need your attention,"
'[ END SETTINGS ]==================================================================
...
Function ramchk()
	...
	End If
	MUseReport = MUseReport & " used, and, "
	If (memoutput = 3) Or (memoutput = 1) Then
...
If SysMode = "R" Then
	SysReport = "        ---=>>> SYSTEM REPORT <<<=---" & vbCrlf
	...
	sapi.Speak "Intitialized and " & Vers & "ready"
...
If SysMode = "R" Then
	sapi.Speak "Here is my written Summary Sir."
